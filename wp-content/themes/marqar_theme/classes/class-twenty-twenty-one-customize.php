		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'marqar_theme' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'marqar_theme' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'marqar_theme' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'marqar_theme' ),
						'full'    => esc_html__( 'Full text', 'marqar_theme' ),
					),
				)
			);
			...
			$wp_customize->add_control(
				new Twenty_Twenty_One_Customize_Color_Control(
					...
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'marqar_theme' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
