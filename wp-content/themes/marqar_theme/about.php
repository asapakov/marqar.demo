    ...
    <div class="container mt-5 w-100">
        ...
        <div style="display: ; margin-bottom: 150px" id="about" class="tabcontent">
            <div class="container w-75 shadow-lg p-3 bgChange" style="padding-bottom: 20px">
                <div>
                    <p style="font-family: Roboto; font-weight: 700; font-size: 28px; color: white">Мы
                        отказались от
                        стандартных программ и применяем только то, что работает эффективно!</p>
                </div>
                <hr class="m-0 p-0">
                <div style="margin-top: 28px">
                    <p style="font-family: Roboto; font-weight: 400; font-size: 18px; color: white; opacity: 0.75">
                        MARQAR — это
                        Казахстанская
                        компания, деятельностью которой является предоставление товаров и услуг на собственной
                        платформе
                        с инновационной системой стимулирования продаж, мотивации к обучению, саморазвитию,
                        повышению
                        профессиональных навыков и морально-этических качеств.
                        Мы формируем социальную бизнес-среду, в которой потребление жизненных благ приносит
                        вознаграждение каждому участнику. Продуктами компании являются кейсы, по различным
                        направлениям
                        видов деятельности человека. Все кейсы формируются по единому принципу. У каждого кейса
                        свой
                        план вознаграждений. Программа содействия занятости — MARQAR
                    </p>
                </div>
                        ...
                        <div class="row mt-5 p-3" style="height: 250px">
                            <div class="col m-0 p-0" style="height: 100%">
                                ...
                                <div class="col ms-2" style="height: 100%">
                                    <div style="color: #DAAB31; font-family: Roboto; font-weight: 700;font-size: 20px"
                                    "><?php the_field('заголовок');
                                    ?></div>
                                <div class="mt-2"
                                     style="font-family: Roboto; font-weight: 400; color: white; opacity: 0.75"><?php the_field('общий_текст');
                                    ?></div>
                            </div>
                        </div>
        ...
        <div style="display: none; margin-bottom: 150px" id="map" class="tabcontent">
            <div class="container w-75 shadow-lg p-3 bgChange" style="padding-bottom: 20px">
                <div>
                    <p style="font-family: Roboto; font-weight: 700; font-size: 28px; color: white">MARQAR -
                ...
                <div style="margin-top: 28px">
                    <p style="font-family: Roboto; font-weight: 400; font-size: 18px; color: white; opacity: 0.75">
                        MARQAR — это
                        Казахстанская
                        компания, деятельностью которой является предоставление товаров и услуг на
                        ...
                        вознаграждение каждому участнику. Продуктами компании являются кейсы, по различным
                        направлениям
                        видов деятельности человека. Все кейсы формируются по единому принципу. У каждого
                        кейса свой
                        план вознаграждений. Программа содействия занятости — MARQAR
                    </p>
                </div>
                ...
                <div>
                    <p style="font-family: Roboto; font-weight: 700; font-size: 28px; color: white"
                       class="mt-5 mb-3">
                        Представители “MARQAR” в вашей стране</p>
                    <p style="font-family: Roboto; font-weight: 400; font-size: 18px; color: white; opacity: 0.75"
                       class="mt-0">
                        Внутренняя методика начисления вознаграждения за участие в товарообороте Компании,
                        доступна при покупке продукта, размещаемая в Веб-офисе (личном кабинете) Агента.

                        Настоящая программа разработана в помощь тем, кто имеет желание и намерение
                        приобретать и продвигать товары и услуги партнеров компании на казахстанском и
                        международном рынках, и получать от Компании стабильное агентское вознаграждение.
                        Обязательным условием включения Участника в Агентскую программу — является
                        приобретение продукта Компании для личного пользования и его продвижение на рынке
                        путем продаж.
                        ...
                        Обязательным условием включения Участника в Агентскую программу — является
                        приобретение продукта Компании для личного пользования и его продвижение на рынке
                        путем продаж. является приобретение продукта Компании для личного пользования и его
                        продвижение на рынке путем продаж. Является приобретение продукта Компании для
                        личного пользования и его продвижение на рынке путем продаж.</p>
                </div>
                       ...
                       style="text-decoration: none; color: inherit">
                        <div class="hoverbig shadow-lg mt-3 mx-auto rounded bgChange "
                            ...
                            <div class="text-start bgChange ps-2 pb-2 align-items-center"
                                 style="font-family: Roboto; font-weight: 300; font-size: 18px; color: white; opacity: 0.75"><?php the_excerpt(); ?></div>
                        </div>
                    </a>
