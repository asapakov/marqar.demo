...
<div name="webV" class="d-none d-sm-block pt-5"
    ...
    <br><br><br>
    <div class="container text-start w-75 mt-3" style="margin-bottom: 200px">
        <div class="container">
            ...
            <div class="d-flex row ">
                <div class="col me-auto"><a href="/новости/"
                                            style="font-family: Roboto; font-weight: 400; font-size: 32px; color: white; opacity: 0.75; text-decoration: none">Новости
                        / </a><a
                            style="font-family: Roboto; font-weight: 500; font-size: 32px; color: white"><?php the_title() ?></a>
                </div>
            </div>
        </div>
        <div class="container p-3 shadow-lg rounded bgChange">
            <div class="w-100"><img class="rounded w-100" style="width: 100%; height: auto"
                                    src="<?php the_post_thumbnail(); ?>"</div>
            <div class=" ms-3 mt-2"><p
                        style="font-family: Roboto; font-weight: 700; font-size: 32px; color: white"><?php the_title() ?></p>
            </div>
            <hr>
            <div class="m-3"
...
<div name="mobV" class="d-block d-sm-none pb-3 px-2"
    ...
    <div class="container mt-4 rounded mx-auto p-0">
        <img class="rounded mx-auto" style="height: auto; width: 100%" src="<?php the_post_thumbnail(); ?>">
    </div>
