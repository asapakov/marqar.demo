  ...
  <div id="page" class="page-wrapp">
    ...
    <header id="masthead" class="page-header page-header--nojs" role="banner">
      <div class="page-header__container container">
        ...
        <a class="page-header__login" href="<?php home_url() ?>/wp-admin">
          <span class="sr-only">Авторизоваться на сайте</span>
          <svg class="page-header__login-icon" width="18" height="18" aria-hidden="true">
