...
add_filter('category_edit_form_fields', 'description1');
...
<table class="form-table">
	...
	<br />
	<span class="description"><?php _e('Описание по умолчанию не выделяется, однако в некоторых темах оно может отображаться.', 'categorytinymce'); ?></span>
	</td>	
        </tr>
